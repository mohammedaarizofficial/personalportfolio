...
function Worksection(){
    return(
        <div className="flex flex-col justify-items-center lg:mt-[350px]" id="work">
            <div className="font-heading lg:text-nav-title font-medium text-center">WORK</div>
            <div className="grid grid-cols-2 lg:flex lg:gap-[50px] lg:justify-center lg:px-[50px] lg:pt-[100px]">
            ...
            <div className="font-heading text-center lg:text-nav-item lg:px-5">
